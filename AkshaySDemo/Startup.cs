...
namespace AkshaySDemo
{
    ...
    {
        public static string ERUDemoDBConnStr;
        public static string AkshaySDemoDBConnStr;
        public static string DefaultConnection;
        public static string OlorinDemoDBConnStr;
        public static string MySQLConnStr;
        public static string PostgreSQLConnStr;
