...
namespace AkshaySDemo
{
    public class Startup
    {
        ...
        public Startup(IConfiguration configuration)
        {
            ...
            AkshaySDemoOracleContext.ConnectionString = OracleConnStr;
